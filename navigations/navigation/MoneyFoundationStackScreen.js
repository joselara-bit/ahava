...
import MoneyFoundationScreen from '../../screens/Foundation/MoneyFoundationScreen'
...
export default function MoneyFoundationStackScreen({ route }) {
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen
                ...
                component={MoneyFoundationScreen}
