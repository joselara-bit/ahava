...
export default function PostHospitalPKUForm({ toastRef, setLoading, email }) {
    ...
    const addHospital = async() => {
        ...
        const responseAddDocument = await addDocumentWithoutId("hospitalPKU", hospital)
        setLoading(false)
...
function FormAdd({ 
    ...
    return (
        <View style={styles.viewForm}>
            ...
            <Input
                placeholder="¿En qué sección del Hospital/Clínica se encuentra el área PKU o de Enfermedades Poco Conocidas?"
                multiline
                containerStyle={styles.textArea}
