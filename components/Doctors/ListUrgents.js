...
export default function ListUrgents({ doctors, navigation, handleLoadMore }) {
...
function Doctor({ doctor, navigation }) {
    const { id, images, name, biography, city, municipality, bloodrequired } = doctor.item
        ...
        <TouchableOpacity onPress={() => goDoctor()} >
            <View style={{flexDirection: 'row', padding: SPACING, marginBottom: SPACING, backgroundColor: 'white', borderRadius: 16,
                ...
                <View>
                    ...
                    <Text style={styles.doctorInformation}>Requiere sangre de tipo: {bloodrequired}</Text>
