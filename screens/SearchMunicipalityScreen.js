...
import { searchMunicipality } from '../utils/Actions'

export default function SearchMunicipalityScreen({ navigation }) {
    ...
    useEffect(() => {
        ...
        async function getData() {
            const response = await searchMunicipality(search)
                    ...
                    isEmpty(search) ? (
                        ...
                        <View>
                            <Text style={styles.promo}>
                                Aquí puedes buscar a cualquier persona con solo digitar el Municipio/Alcaldía en la que quieras donar sangre. {'\n'} {'\n'}¿Qué esperas? Millones de personas necesitan de tu ayuda
                            </Text>

                            <Button
                                title="Buscar por Colonia"
                                buttonStyle={styles.btnSuburbSearch}
