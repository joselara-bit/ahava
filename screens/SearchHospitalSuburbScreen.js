...
import { searchHospitalSuburb } from '../utils/Actions'

export default function SearchHospitalSuburbScreen({ navigation }) {
    ...
    useEffect(() => {
        ...
        async function getData() {
            const response = await searchHospitalSuburb(search)
