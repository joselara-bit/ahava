...
import PostHospitalForm from '../../components/Doctors/PostHospitalForm'
...
export default function PostHospital({ navigation }) {
    ...
    return (
        <KeyboardAwareScrollView>
             <Text style={{ color: "#F41635", fontSize: 32, fontWeight: "bold", marginLeft: 80, marginTop: 35, marginBottom: -45, }}>Publicar Hospital o Clínica</Text>
        <Icon 
                type="ionicon"
                name="chevron-back"
                color="#F41635"
