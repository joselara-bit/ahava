...
export default function LinkCampainAdd({navigation}) {
    return (
        <ScrollView style={styles.view}>
            ...
            <Text style={styles.subtitle}>Vamos a Ahavá y copiamos el enlace en la casilla "Pon aquí el link de tu campaña para donarte dinero: "{`\n`}{`\n`}Este paso lo podrás repetir en la otra casilla inferior a esta, y con cualquier otro link que tengas para poderte donar dinero.</Text>
