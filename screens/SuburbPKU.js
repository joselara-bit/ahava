...
import { searchSuburbPKU } from '../utils/Actions'

export default function SearchSuburbPKU({ navigation }) {
    ...
    useEffect(() => {
        ...
        async function getData() {
            const response = await searchSuburbPKU(search)
                ...
                size(users) > 0 ? (
                    ...
                    <View>
                        <Text style={styles.promo}>
                            Aquí podrás buscar cualquier hospital y clínica con solo digitar la colonia. {'\n'} {'\n'}¿Qué esperas? Millones de personas necesitan de tu ayuda
                        </Text>
