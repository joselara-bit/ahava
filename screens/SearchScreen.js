            ...
            />
            {
                size(doctors) > 0 ? (
                    ...
                    <View>
                      ...
                      {/*   <Button
                                title="Buscar campañas de Apoyo Económico"
                                buttonStyle={styles.btnSuburb}
                                titleStyle={styles.btnSuburbTitle}
                                onPress={() => navigation.navigate("Buscar Campaña")}
                            /> */}

                        <Button
                                title="Buscar Campañas de PKU y Enfermedades Poco Conocidas"
                                buttonStyle={styles.btnSuburb}
                                titleStyle={styles.btnSuburbTitle}
                                onPress={() => navigation.navigate("Buscar PKU")}
                            />               
                    </View>
                    ) : (
    ...
    return (
        ...
        >
            ...
            <ListItem.Content>
                ...
                <ListItem.Subtitle>Ciudad: {city}, {municipality} </ListItem.Subtitle>
...
const styles = StyleSheet.create({
    ...
    title: {
        fontSize: 32, fontWeight: "bold", color: "black", top: 35, left: 60, color: "#F41635", bottom: -15, marginRight: 75,
    },
