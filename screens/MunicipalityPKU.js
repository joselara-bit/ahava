...
import { searchMunicipalityPKU } from '../utils/Actions'

export default function SearchMunicipalityPKU({ navigation }) {
    ...
    useEffect(() => {
        ...
        async function getData() {
            const response = await searchMunicipalityPKU(search)
                ...
                size(users) > 0 ? (
                    ...
                    <View>
                        <Text style={styles.promo}>
                            Aquí podrás buscar cualquier hospital y clínica con solo digitar el Municipio/Alcaldía. {'\n'} {'\n'}¿Qué esperas? Millones de personas necesitan de tu ayuda
                        </Text>
