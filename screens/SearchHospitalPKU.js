...
import { searchHospitalPKU } from '../utils/Actions'

export default function SearchHospitalPKU({ navigation }) {
    ...
    useEffect(() => {
        ...
        async function getData() {
            const response = await searchHospitalPKU(search)
                ...
                size(users) > 0 ? (
                    ...
                    <View>
                        <Text style={styles.promo}>
                            Aquí podrás buscar cualquier hospital y clínica con solo digitar su nombre. {'\n'} {'\n'}¿Qué esperas? Millones de personas necesitan de tu ayuda
                        </Text>
                        ...
                        <Button
                                ...
                                onPress={() => navigation.navigate("CityPKU")}
                            />
                            ...
                            <Button
                                ...
                                buttonStyle={styles.btnMunicipality}
                                titleStyle={styles.btnMunicipalityTitle}
                                onPress={() => navigation.navigate("MunicipalityPKU")}
                            />
                            ...
                            <Button
                                ...
                                onPress={() => navigation.navigate("SuburbPKU")}
                            />
