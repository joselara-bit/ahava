...
export default function HospitalsScreen() {
    ...
    useFocusEffect(
        useCallback(() => {
            async function getData() {
                ...
                setLoading(true);
                const response = await getHospitals(limitHospitals);
    ...
    const handleLoadMore = async() => {
        ...
        setLoading(true);
            const response = await getMoreHospitals( limitHospitals, startHospital );
    ...
    return (
        ...
        <Text style={{ color: "#F41635", fontSize: 40, fontWeight: "bold", marginLeft: 90, marginTop: 30, marginBottom: -75, }}>Bancos de Sangre</Text>
        <Icon 
                type="ionicon"
                name="chevron-back"
                color="#F41635"
            ...
            <Text style={{ fontSize: 32, fontWeight: "bold", color: "black", left: 15, top: 20, color: "#F41635",  marginBottom: 25, marginRight: 15, }}>Bancos de sangre a nivel nacional</Text>
        {
            size(hospitals) > 0 ? (
                ...
                <View style={styles.notFoundView}>
                    <Text style={styles.notFoundText}>No hay bancos de sangre disponibles.</Text>
                </View>
            )
