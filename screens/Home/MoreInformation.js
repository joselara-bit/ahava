...
export default function MoreInformation({ navigation }) {
    ...
    return (
        <ScrollView style={styles.view}>
            ...
            <Text style={styles.title}>Ayudar</Text>
            ...
            <Text style={styles.text}>Hola, qué tal. Nos emociona muchísimo que deseés ayudar a los demás. Por el momento no tenemos la posibilidad de agendar una cita con Hospital o Clínica para que puedar donar sangre en su Banco de Sangre, pero próximamente estará disponible dicha función. Por el momento te invitamos a que te pongamos en contacto directamente con el Hospital o Clínica, para reservar tu cita al Banco de Sangre.{'\n'} {'\n'}</Text>
